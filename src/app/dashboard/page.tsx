          ...
          <div className="p-6 pt-0 space-y-4">
            ...
            <div className="grid grid-cols-1 gap-2">
              <div className="p-3 bg-gradient-primary/10 border border-primary/20 rounded-lg backdrop-blur-sm">
                ...
                <p className="text-lg font-semibold text-primary">+{loyaltyData.pendingPoints} pts</p>
            ...
            <div className="grid grid-cols-1 gap-2">
                ...
                <span className="inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&amp;_svg]:pointer-events-none [&amp;_svg]:size-4 [&amp;_svg]:shrink-0 bg-gradient-primary shadow-primary text-primary-foreground hover:shadow-glow hover:scale-[1.05] font-semibold h-10 px-4 py-2">
                  Redeem Points
                </span>
